...
namespace RuneFoxMods.RoRSkinBuilderExtension
{
    ...
    public partial class ExtensionTemplate : ExtensionTemplateBase
    {
        /// <summary>
...
{ 
            this.Write("      BeforeStartDelegate += _");
            this.Write(this.ToStringHelper.ToStringWithCulture(extension.Name));
            this.Write("Extension.BeforeStart;\r\n");
...
");
 foreach(var extension in info.extensions)
{ 
            this.Write("      AfterStartDelegate += _");
            this.Write(this.ToStringHelper.ToStringWithCulture(extension.Name));
            this.Write("Extension.AfterStart;\r\n");
...
");
 foreach(var extension in info.extensions)
{ 
            this.Write("      BeforeBodyCatalogDelegate += _");
            this.Write(this.ToStringHelper.ToStringWithCulture(extension.Name));
            this.Write("Extension.BeforeBodyCatalogInit;\r\n");
...
");
 foreach(var extension in info.extensions)
{ 
            this.Write("      AfterBodyCatalogDelegate += _");
            this.Write(this.ToStringHelper.ToStringWithCulture(extension.Name));
            this.Write("Extension.AfterBodyCatalogInit;\r\n");
...
");
 foreach(var skin in info.modInfo.skins) { 
            this.Write("    static event EventHandler<SkinAddedArgs> ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skin.bodyName.ToUpperCamelCase() + skin.name.ToUpperCamelCase()));
            this.Write("SkinAddedEvent;\r\n    static partial void ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skin.bodyName.ToUpperCamelCase() + skin.name.ToUpperCamelCase()));
            this.Write("SkinAdded(SkinDef skinDef, GameObject bodyPrefab) { ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skin.bodyName.ToUpperCamelCase() + skin.name.ToUpperCamelCase()));
            this.Write("SkinAddedEvent.Invoke(Instance, new SkinAddedArgs(skinDef, bodyPrefab)); }\r\n\r\n");
 } 
            this.Write(@"    //Implementation of  Partial Skin Added Functions from Plugin
    ///////////////////////////////////////////
...
");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class ExtensionTemplateBase
    {
        #region Fields
